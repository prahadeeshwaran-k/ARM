...
void config_interrupt(void){
	...
	VICIntSelect= 1<<EXT_INT0; //Select all Interrupt as IRQs(5.6 Interrupt sources) Table in Datasheet
	...
	//VICVectAddr0 = (int)FIQ_Handler;// Function Pointer type casted to integer address.
}
